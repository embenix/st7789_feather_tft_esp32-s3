...
void app_main(void)
{
	...
	//Enable the Power to the LCD
	if (CONFIG_I2C_PWR_GPIO > -1){
		gpio_reset_pin( CONFIG_I2C_PWR_GPIO );
		gpio_set_direction( CONFIG_I2C_PWR_GPIO, GPIO_MODE_OUTPUT );
		gpio_set_level( CONFIG_I2C_PWR_GPIO, 1 );
	}
